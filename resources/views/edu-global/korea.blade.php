            ...
            <div class="row gy-4 align-items-center features-item">
                ...
                <div class="col-lg-7 order-1 order-lg-2 d-flex align-items-center" data-aos="zoom-out"
                    ...
                    <div class="image-stack">
                        <img src="{{ asset('/public/images/uploads/cms/' . $CMS['korea2']) }}" alt=""
                             class="stack-front">
                        <img src="{{ asset('/public/images/uploads/cms/' . $CMS['korea1']) }}" alt=""
                             class="stack-back">
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div class="service-box">
                        ...
                        <div class="download-catalog">
                            <a href="#"><i class="bi bi-filetype-pdf"></i><span> Seoul National University (SNU) - Seoul, Seoul Special City</span></a>
                            <a href="#"><i class="bi bi-file-earmark-word"></i><span>Korea Advanced Institute of Science and Technology (KAIST) - Daejeon, Daejeon Metropolitan City</span></a>
                            <a href="#"><i class="bi bi-file-earmark-word"></i><span> Pohang University of Science and Technology (POSTECH) - Pohang, North Gyeongsang Province</span></a>
                            <a href="#"><i class="bi bi-file-earmark-word"></i><span>Yonsei University - Seoul, Seoul Special City</span></a>
                            <a href="#"><i class="bi bi-file-earmark-word"></i><span>Korea University - Seoul, Seoul Special City
                                </span></a>
                        </div>
                    </div><!-- End Services List -->
