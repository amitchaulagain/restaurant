    ...
    <div class="page-title" data-aos="fade">
        <nav class="breadcrumbs">
            <div class="container">
                <ol>
                    <li><a href="/">Home</a></li>
                    <li class="current">New Zealand</li>
                </ol>
            </div>
        </nav>
    </div><!-- End Page Title -->
            ...
            <div class="row gy-4 align-items-center features-item">
                ...
                <div class="col-lg-7 order-1 order-lg-2 d-flex align-items-center" data-aos="zoom-out"
                    ...
                    <div class="image-stack">
                        <img src="{{ asset('/public/images/uploads/cms/' . $CMS['nz2']) }}" alt="" class="stack-front">
                        <img src="{{ asset('/public/images/uploads/cms/' . $CMS['nz1']) }}" alt="" class="stack-back">
                    </div>
                </div>
            </div>
        </div>
